...
int main() {
    ...
    // Tentukan jumlah hari maksimal per bulan
    int maxHari;
    ...
    switch (bln) {
        ...
        case 4: case 6: case 9: case 11:
            ...
            break;
        case 2:
            maxHari = 28;  // Februari dibatasi 29 (anggap tahun kabisat)
            break;
        default:
    ...
    // Validasi tanggal
    if (tgl < 1 || tgl > maxHari) {
        cout << "\nTanggal tidak valid untuk bulan tersebut.\n";
        return 1;
    }
